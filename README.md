...
176. time targets for NGUs - calculates and sets target level for that NGU to run for x minutes
  - set number of minutes in the resource input box at the top of the screen- ctrl-click the cap button next to desired NGU or ctrl-click the cap all button to set targets for all
