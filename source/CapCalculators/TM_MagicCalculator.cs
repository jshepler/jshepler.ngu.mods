...
{
    internal class TM_MagicCalculator : BaseCalculator
    {
        ...
        internal TM_MagicCalculator(TimeMachineController controller)
        {
        ...
        protected override void UpdateModifier()
        {
            ...
            d = _controller.baseGoldMultiDivider();
 ...
 * s = sad divider
 * 
 *  from TimeMachineController.goldMultiProgressPerTick()
