...
// refactored to classes in ItemTooltips folder
namespace jshepler.ngu.mods
{
    ...
    internal class ImprovedItemTooltips
    {
        ...
        //        var messageField = Traverse.Create(__instance).Field<string>("message");
        //        StartShowTooltip(item, __instance.updateTooltipMessage, () => messageField.Value, () => character.inventory.GetItem(slotId).id == 0);
        //    }
        ...
        //    var item = Plugin.Character.inventory.GetItem(slotId);
        //    var messageField = Traverse.Create(__instance).Field<string>("message");
        //    StartShowTooltip(item, __instance.updateTooltipMessage, () => messageField.Value);
        ...
        //private static void StartShowTooltip(Equipment item, Action updateTooltipMessage, Func<string> getTooltipMessage, Func<bool> stopShowingTooltip = null)
        //{
        //    StopShowTooltip();
        //    _cor = Plugin.Character.StartCoroutine(ShowTooltip(item, updateTooltipMessage, getTooltipMessage, stopShowingTooltip));
        //}
        ...
        //private static IEnumerator ShowTooltip(Equipment item, Action updateTooltipMessage, Func<string> getTooltipMessage, Func<bool> stopShowingTooltip)
        //{
        //    var character = Plugin.Character;

        //    while (true)
        //    {
        //        if (stopShowingTooltip != null && stopShowingTooltip())
        //            break;
